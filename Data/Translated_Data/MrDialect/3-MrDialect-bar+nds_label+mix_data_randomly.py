...
files = ['bar_MrDialekt_resized.tsv', 'nds_MrDialekt_resized.tsv', 'de_Wiki_cleaned_resized_NewLine_resized.tsv']
...
with open('MrDialect_de+nds+bar_mixed.tsv', 'w', encoding='utf-16') as outfile:
