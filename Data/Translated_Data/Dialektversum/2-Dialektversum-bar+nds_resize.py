...
files = [['bar_Dialektversum-RespektEmpire.tsv'], ['nds_Dialektversum-Oeverstetter.tsv'], ['de_Wiki_cleaned_resized_NewLine.tsv']]
...
target_size = 36256  # size of the smallest data set # min(len(files[0]), len(files[1]), len(files[2]))
